...
def test_sending_a_fake_report():
    reporter = issue_reporter.IssueReporter(
        from_address="errors@q-continuum.net",
        to_address="q@q-continuum.net",
        mailgun_api_key="key-10k0owvah9n62asajwu487d4a139k6j0",
    )
